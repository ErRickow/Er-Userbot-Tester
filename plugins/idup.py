...
modules = prefix
alive_logo = (
    db.get("core.main", "ALIVE_LOGO", "alive_logo") or "https://telegra.ph/file/9dc4e335feaaf6a214818.jpg"
)
emoji = db.get("core.main", "ALIVE_EMOJI", "emoji") or "⚡️"
alive_text = db.get("core.main", "ALIVE_TEKS_CUSTOM", "alive_text") or "Hey, I am alive."
...
async def alive(client: Client, message: Message):
    ...
    man = (
        ...
        f"    **[𝗦𝘂𝗽𝗽𝗼𝗿𝘁](https://t.me/)** | **[𝗖𝗵𝗮𝗻𝗻𝗲𝗹](https://t.me/)** | **[𝗢𝘄𝗻𝗲𝗿](tg://user?id={client.me.id})**"
    )
    try:
...
async def setemoji(client: Client, message: Message):
    ...
    sql.db.set("core.main", "ALIVE_EMOJI", emoji)
